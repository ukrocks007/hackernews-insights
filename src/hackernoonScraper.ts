...
export async function scrapeTaggedStories(
  tagUrl: string = "https://hackernoon.com/tagged/hackernoon-top-story",
  limit: number = 30,
  pageNum: number = 1,
): Promise<HackernoonItem[]> {
  ...
  try {
    ...
    for (const a of anchors) {
      ...
      try {
        ...
        if (
          u.hostname !== "hackernoon.com" &&
          u.hostname !== "www.hackernoon.com"
        )
          continue;
